...
#$ -pe impi_hydra 16
#
#$ -o /tokp/scratch/mkraus/viRMHD2D/current_sheet_512x256_asm.$JOB_ID.out
#$ -e /tokp/scratch/mkraus/viRMHD2D/current_sheet_512x256_asm.$JOB_ID.err
#
#$ -m e
...
RUNID=current_sheet_512x256_asm
