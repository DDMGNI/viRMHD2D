...
#$ -pe impi_hydra 16
#
#$ -o /tokp/scratch/mkraus/viRMHD2D/reconnection_1024x512_part1.$JOB_ID.out
#$ -e /tokp/scratch/mkraus/viRMHD2D/reconnection_1024x512_part1.$JOB_ID.err
#
#$ -m e
...
RUNID=reconnection_1024x512_part1
